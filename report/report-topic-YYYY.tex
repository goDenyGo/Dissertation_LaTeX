...
\input{report/Chapters/authors}
\input{report/Chapters/referat.tex}

\tableofcontents

\input{report/Chapters/abreviations.tex}
\input{report/Chapters/introduction.tex}

\mainmatter %% вмикаємо нумераці.

\input{report/Chapters/chapter-example1.tex}
\input{report/Chapters/chapter-example2.tex}

\backmatter

\input{report/Chapters/conclusion.tex}

\clearpage
\addcontentsline{toc}{chapter}{ПЕРЕЛІК ДЖЕРЕЛ ПОСИЛАННЯ}
\bibliographystyle{gost780}
\bibliography{report/Bibliography/literatura}
